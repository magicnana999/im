...
var file_packet_proto_goTypes = []any{
	...
	(*MQMessage)(nil),           // 10: pb.MQMessage
	(*ApiResult)(nil),           // 11: pb.ApiResult
	(*LoginRequest)(nil),        // 12: pb.LoginRequest
	(*LoginReply)(nil),          // 13: pb.LoginReply
	(*LogoutRequest)(nil),       // 14: pb.LogoutRequest
	(*FriendRequest)(nil),       // 15: pb.FriendRequest
	(*FriendRequestAgree)(nil),  // 16: pb.FriendRequestAgree
	(*FriendRequestReject)(nil), // 17: pb.FriendRequestReject
}
var file_packet_proto_depIdxs = []int32{
	...
	12, // 3: pb.CommandBody.loginRequest:type_name -> pb.LoginRequest
	14, // 4: pb.CommandBody.logoutRequest:type_name -> pb.LogoutRequest
	15, // 5: pb.CommandBody.friendRequest:type_name -> pb.FriendRequest
	16, // 6: pb.CommandBody.friendRequestAgree:type_name -> pb.FriendRequestAgree
	17, // 7: pb.CommandBody.friendRequestReject:type_name -> pb.FriendRequestReject
	13, // 8: pb.CommandBody.loginReply:type_name -> pb.LoginReply
	4,  // 9: pb.MessageBody.at:type_name -> pb.At
	5,  // 10: pb.MessageBody.refer:type_name -> pb.Refer
	6,  // 11: pb.MessageBody.textContent:type_name -> pb.TextContent
	7,  // 12: pb.MessageBody.imageContent:type_name -> pb.ImageContent
	8,  // 13: pb.MessageBody.audioContent:type_name -> pb.AudioContent
	9,  // 14: pb.MessageBody.videoContent:type_name -> pb.VideoContent
	6,  // 15: pb.Refer.textContent:type_name -> pb.TextContent
	7,  // 16: pb.Refer.imageContent:type_name -> pb.ImageContent
	8,  // 17: pb.Refer.audioContent:type_name -> pb.AudioContent
	9,  // 18: pb.Refer.videoContent:type_name -> pb.VideoContent
	3,  // 19: pb.MQMessage.message:type_name -> pb.MessageBody
	13, // 20: pb.ApiResult.loginReply:type_name -> pb.LoginReply
	12, // 21: pb.UserApi.Login:input_type -> pb.LoginRequest
	14, // 22: pb.UserApi.Logout:input_type -> pb.LogoutRequest
	15, // 23: pb.FriendApi.AddRequest:input_type -> pb.FriendRequest
	16, // 24: pb.FriendApi.AgreeRequest:input_type -> pb.FriendRequestAgree
	17, // 25: pb.FriendApi.RejectRequest:input_type -> pb.FriendRequestReject
	11, // 26: pb.UserApi.Login:output_type -> pb.ApiResult
	11, // 27: pb.UserApi.Logout:output_type -> pb.ApiResult
	11, // 28: pb.FriendApi.AddRequest:output_type -> pb.ApiResult
	11, // 29: pb.FriendApi.AgreeRequest:output_type -> pb.ApiResult
	11, // 30: pb.FriendApi.RejectRequest:output_type -> pb.ApiResult
