...
//╰$ protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative actor.proto
...
func (x *ActorResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActorResult) ProtoMessage() {}

func (x *ActorResult) ProtoReflect() protoreflect.Message {
	mi := &file_actor_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ActorResult.ProtoReflect.Descriptor instead.
func (*ActorResult) Descriptor() ([]byte, []int) {
	return file_actor_proto_rawDescGZIP(), []int{0}
}

func (x *ActorResult) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ActorResult) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_actor_proto_rawDesc = []byte{
	...
	0x62, 0x22, 0x3b, 0x0a, 0x0b, 0x41, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04,
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x07,
...
var file_actor_proto_goTypes = []any{
	(*ActorResult)(nil), // 0: pb.ActorResult
}
